...
/**
 * Optional Elements The following elements are optional and may appear as
 * sub-elements of &lt;channel&gt;, &lt;item&gt;, &lt;media:content&gt; and/or
 * &lt;media:group&gt;. When an element appears at a shallow level, such as
 * &lt;channel&gt; or &lt;item&gt;, it means that the element should be applied
 * to every media object within its scope.
 *
...
public class Metadata implements Cloneable, Serializable {
	...
	/**
	 * status is the status of the media object saying whether a media object has
	 ...
	 * </pre>
	 *
	 * <em>scheme</em> is the URI that identifies the categorization scheme. It is
	 * an optional attribute. If this attribute is not included, the default scheme
	 * is 'http://search.yahoo.com/mrss/category_schema'.
	 *
	 * <em>label</em> is the human readable label that can be displayed in end user
	...
	/**
	 * This element stands for the community related content. This allows inclusion
	 * of the user perception about a media object in the form of view count,
	 * ratings and tags.
	 *
	 * <pre>
	 * &lt;media:community&gt;
	 ...
	 * </pre>
	 *
	 * starRating This element specifies the rating-related information about a
	 * media object. Valid attributes are average, count, min and max.
	 *
	 * statistics This element specifies various statistics about a media object
	 * like the view count and the favorite count. Valid attributes are views and
	 * favorites.
	 *
	 * tags This element contains user-generated tags separated by commas in the
	 ...
	 * weight is determined for a tag; for example, number of occurences can be one
	 ...
	 * information. If the media is operating under a Creative Commons license, the
	 ...
	 * optional attribute.
	 *
	 * <em>scheme</em> is the URI that identifies the role scheme. It is an optional
	 ...
	 * It has 1 optional attribute.
	 *
	 * <pre>
	 * &lt;media:description type="plain"&gt;This was some really bizarre band I listened to as a young lad.&lt;/media:description&gt;
	 * </pre>
	 * 
	 * <em>type</em> specifies the type of text embedded. Possible values are either
	 * 'plain' or 'html'. Default value is 'plain'. All html must be entity-encoded.
	 ...
	 * video. &lt;media:embed&gt; allows inclusion of such information in the form
	 * of key-value pairs.
	 *
	 * <pre>
	 ...
	 * long as each instance is a different <em>algo</em>. It has 1 optional
	 * attribute.
	 *
	 * <pre>
	...
	/**
	 * Highly relevant keywords describing the media object with typically a maximum
	 * of ten words. The keywords and phrases should be comma delimited.
	 *
	 * <pre>
	 ...
	 *
	 * start time at which the reference to a particular location starts in the
	 * media object.
	 *
	 * end time at which the reference to a particular location ends in the media
	 * object.
	 *
	...
	/**
	 * 
	 * Optional tag to include pricing information about a media object. If this tag
	 * is not present, the media object is supposed to be free. One media object can
	 * have multiple instances of this tag for including different pricing
	 * structures. The presence of this tag would mean that media object is not
	 * free.
	 *
	 * 
	 * <pre>
	 ...
	 *
	 * 
	 * type Valid values are "rent", "purchase", "package" or "subscription". If
	 * nothing is specified, then the media is free.
	 *
	 * 
	 * 
	 * info if the type is "package" or "subscription", then info is a URL pointing
	 ...
	 * 
	 * 
	 * currency -- use <a href="http://en.wikipedia.org/wiki/ISO_4217">ISO 4217</a>
	 * for currency codes. This is an optional attribute.
	 *
	 * 
	 * @return the prices
	 */
	 ...
	 * optional attribute. If this attribute is not included, the default scheme is
	...
	/**
	 * 
	 * Allows restrictions to be placed on the aggregator rendering the media in the
	 * feed. Currently, restrictions are based on distributor (uri) and country
	 * codes. This element is purely informational and no obligation can be assumed
	 * or implied. Only one &lt;media:restriction&gt; element of the same
	 * <em>type</em> can be applied to a media object - all others will be
	 ...
	 * reserved: 'all', 'none'. These literals can only be used once. This element
	 * has 1 required attribute, and 1 optional attribute (with strict requirements
	 * for its exclusion).
	 *
	 * 
	 * <pre>
	 ...
	 *
	 * 
	 * <em>relationship</em> indicates the type of relationship that the restriction
	 * represents (allow | deny). In the example above, the media object should only
	...
	/**
	 * Optional element to specify various scenes within a media object. It can have
	 * multiple child &lt;media:scene&gt; elements, where each &lt;media:scene&gt;
	 * element contains information about a particular scene. &lt;media:scene&gt;
	 * has the optional sub-elements &lt;sceneTitle&gt;, &lt;sceneDescription&gt;,
	 * &lt;sceneStartTime&gt; and &lt;sceneEndTime&gt;, which contains title,
	 * description, start and end time of a particular scene in the media,
	 * respectively.
	 *
	 * <pre>
	 * &lt;media:scenes&gt;
	 ...
	 *
	 * 
	 * state can have values "active", "blocked" or "deleted". "active" means a
	 * media object is active in the system, "blocked" means a media object is
	 * blocked by the publisher, "deleted" means a media object has been deleted by
	 * the publisher.
	 *
	 * 
	 * reason is a reason explaining why a media object has been blocked/deleted. It
	 * can be plain text or a URL.
	 *
	 * 
	 ...
	 * attributes. Language is based on RFC 3066. There can be more than one such
	 * tag per media element, for example one per language. Please refer to
	 * <a href="http://www.w3.org/AudioVideo/TT">Timed Text spec - W3C</a> for more
	 ...
	 * the <em>start</em> time. Elements can have overlapping <em>start</em> and
	 ...
	 * captioning. It uses the NTP time code format (see: the time attribute used in
	 * &lt;media:thumbnail&gt;).&nbsp;It is an optional attribute.
	 *
	 * 
	 * 
	 * <em>end</em> specifies the end time that the text is relevant. If this
	 * attribute is not provided, and a <em>start</em> time is used, it is expected
	 ...
	 * object. If multiple thumbnails are included, and time coding is not at play,
	 * it is assumed that the images are in order of importance. It has 1 required
	 ...
	 * video. The format for this attribute should be in the DSM-CC's Normal Play
	 * Time (NTP) as used in RTSP [<a href="http://www.ietf.org/rfc/rfc2326.txt">RFC
	 * 2326 3.6 Normal Play Time</a>]. It is an optional attribute.
	 *
	 * 
