/*
 * Copyright 2018-2019 Tom G., tomgapplicationsdevelopment@gmail.com
 *
...
public class WfwTest extends AbstractTestCase {
    private String commentSample = "https://sample.de";
	...
	assertEquals(commentSample, wfwModule.getComment());
	...
	wfwModule.setComment(commentSample);
