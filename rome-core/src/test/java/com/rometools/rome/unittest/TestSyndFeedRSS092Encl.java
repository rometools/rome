...
public class TestSyndFeedRSS092Encl extends TestSyndFeedRSS092 {

    public TestSyndFeedRSS092Encl() {
        this("rss_0.92", "rss_0.92_encl.xml");
    }

    protected TestSyndFeedRSS092Encl(final String feedType, final String feedFileName) {
